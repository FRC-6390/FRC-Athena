...
final class MechanismControlLoopScalingTest {
    ...
    void periodicSimpleFeedforwardUsesVelocitySetpointNotPositionSetpoint() {
        ...
        cfg.control(c -> c.ff("ff", 0.0, 1.0, 0.0).periodic("ff"));
    ...
    private static final class TestMechanism extends Mechanism {
        ...
        private void pidMeasurement(double value) {
            this.pidMeasurement = value;
        }

        @Override
        protected double getPidMeasurement() {
            return pidMeasurement;
        }
    }
