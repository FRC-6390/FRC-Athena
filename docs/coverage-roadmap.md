...
This roadmap tracks the promoted V3 replacement work in the repository root.
Replaced legacy Java modules have been evicted; preserved separate workspaces
...
| Root promotion from the temporary 2027 workspace | root `settings.gradle`, root `build.gradle`, `README.md`, `docs/completion-evidence.md` |

## Remaining Major Migrations

No remaining major migrations are tracked for the fluent Java V3 replacement
pass. Preserved separate workspaces should enter this document as concrete
adapter, dashboard workspace, annotation DSL, HeliOS, ARCP, or robot-use-case
requirements.
