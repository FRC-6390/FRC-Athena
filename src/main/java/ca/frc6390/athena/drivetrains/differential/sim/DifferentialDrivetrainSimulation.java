...
public class DifferentialDrivetrainSimulation {
    ...
    private static DCMotor resolveMotor(Motor motorType, int motorsPerSide) {
        int count = Math.max(1, motorsPerSide);
        Motor resolved = motorType != null ? motorType : Motor.FALCON_500;
        return switch (resolved) {
            ...
            case NEO_V1 -> DCMotor.getNEO(count);
