...
public record SimRef(
    ...
    public SimRef moi(double moi) {
        return new SimRef(kind, OptionalDouble.of(moi), lengthMeters, gearRatio, simulatesGravity, motors, encoders, refs);
    }

    public SimRef lengthMeters(double lengthMeters) {
        return new SimRef(kind, moi, OptionalDouble.of(lengthMeters), gearRatio, simulatesGravity, motors, encoders, refs);
    }

    public SimRef gearRatio(GearRatioRef gearRatio) {
        return new SimRef(kind, moi, lengthMeters, Objects.requireNonNull(gearRatio, "gearRatio"), simulatesGravity, motors, encoders, refs);
    }

    public SimRef gravity(boolean simulatesGravity) {
        return new SimRef(kind, moi, lengthMeters, gearRatio, simulatesGravity, motors, encoders, refs);
    }
    ...
    public SimRef motor(MotorRef motor) {
        ...
        updated.add(motor);
        return new SimRef(kind, moi, lengthMeters, gearRatio, simulatesGravity, updated, encoders, refs);
    }
    ...
    public SimRef encoder(EncoderRef encoder) {
        ...
        updated.add(encoder);
        return new SimRef(kind, moi, lengthMeters, gearRatio, simulatesGravity, motors, updated, refs);
    }
    ...
    public SimRef ref(Object ref) {
        ...
        updated.add(ref);
        return new SimRef(kind, moi, lengthMeters, gearRatio, simulatesGravity, motors, encoders, updated);
    }
