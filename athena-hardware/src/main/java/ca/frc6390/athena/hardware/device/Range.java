...
public record Range(double minimum, double maximum, String unit) {
     ...
     * @return range ref
     */
    public static Range degrees(double minimum, double maximum) {
        return new Range(minimum, maximum, "deg");
    }
     ...
     * @return range ref
     */
    public static Range rotations(double minimum, double maximum) {
        return new Range(minimum, maximum, "rot");
    }
     ...
     * @return range ref
     */
    public static Range of(double minimum, double maximum) {
        return new Range(minimum, maximum, "units");
    }
