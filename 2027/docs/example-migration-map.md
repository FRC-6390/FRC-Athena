...
This map connects the frozen legacy example catalog to the 2027 replacement
example project. Rows marked `Implemented` have a 2027 example, test, and
...
| Legacy Example | 2027 Coverage | Status | Notes |
| --- | --- | --- | --- |
