...
Status: accepted V3 direction, implementation active in `2027/`
...
The V3 API direction is accepted. The `2027/` workspace now owns the fluent Java
...
These are direction-level decisions with implementation work tracked in
`2027/`.
...
are added. A vendor is considered part of the current 2027 implementation set
