...
public interface StatefulLike<E extends Enum<E> & StateMachine.SetpointProvider<Double>> {
    ...
    final class StateMachineSection<E extends Enum<E> & StateMachine.SetpointProvider<Double>> {
        ...
        public StateMachineSection<E> queue(E state) {
            core.getStateMachine().queue(state);
            return this;
        }
        ...
        public StateMachineSection<E> force(double setpoint) {
            core.forceSetpoint(setpoint);
            return this;
        }

        public StateMachineSection<E> force(E target) {
            core.forceState(target);
            return this;
        }
        ...
        public boolean atGoal() {
            return core.getStateMachine().atGoal();
        }

        @SafeVarargs
        public final boolean at(E... states) {
            return core.getStateMachine().at(states);
        }
