 ...
 */
public record HolonomicPidConstants(double kP, double kI, double kD, double iZone, boolean inverted) {
    ...
    public HolonomicPidConstants(double kP, double kI, double kD, double iZone) {
        this(kP, kI, kD, iZone, false);
    }
    ...
    public HolonomicPidConstants withInverted(boolean inverted) {
